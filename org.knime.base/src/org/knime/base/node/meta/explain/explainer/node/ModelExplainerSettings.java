 ...
 */
public class ModelExplainerSettings {

    /**
     *
     */
    private static final String CFG_TREAT_ALL_COLUMNS_AS_SINGLE_FEATURE = "treatAllColumnsAsSingleFeature";
    ...
    public void loadSettingsDialog(final NodeSettingsRO settings, final DataTableSpec inSpec) {
        ...
        m_treatAllColumnsAsSingleFeature = settings.getBoolean(CFG_TREAT_ALL_COLUMNS_AS_SINGLE_FEATURE, false);
    ...
    public void loadSettingsModel(final NodeSettingsRO settings) throws InvalidSettingsException {
        ...
        m_treatAllColumnsAsSingleFeature = settings.getBoolean(CFG_TREAT_ALL_COLUMNS_AS_SINGLE_FEATURE);
    ...
    public void saveSettings(final NodeSettingsWO settings) {
        ...
        settings.addBoolean(CFG_TREAT_ALL_COLUMNS_AS_SINGLE_FEATURE, m_treatAllColumnsAsSingleFeature);
