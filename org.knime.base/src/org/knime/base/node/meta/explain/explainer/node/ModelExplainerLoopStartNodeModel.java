 ...
 */
public class ModelExplainerLoopStartNodeModel extends NodeModel implements LoopStartNodeTerminator {
    ...
    private ModelExplainer m_modelExplainer;

    private ModelExplainerSettings m_settings = new ModelExplainerSettings();

    /**
     * @return the estimator used to create rows in the loop start node
     */
    ModelExplainer getEstimator() {
        if (m_modelExplainer == null) {
            m_modelExplainer = new ModelExplainer(m_settings);
        }
        return m_modelExplainer;
    }
     ...
     *
     */
    public ModelExplainerLoopStartNodeModel() {
        super(NUM_INPORTS, 1);
    }
    ...
    protected DataTableSpec[] configure(final DataTableSpec[] inSpecs) throws InvalidSettingsException {
        ...
        return new DataTableSpec[]{m_modelExplainer.configureLoopStart(roiSpec, samplingSpec, m_settings)};
    }
    ...
    protected BufferedDataTable[] execute(final BufferedDataTable[] inData, final ExecutionContext exec)
        ...
        final BufferedDataTable result = m_modelExplainer.executeLoopStart(roiTable, samplingTable, exec);
        pushFlowVariableInt("currentIteration", m_modelExplainer.getCurrentIteration());
        pushFlowVariableInt("maxIterations", m_modelExplainer.getNumberOfIterations());
    ...
    public boolean terminateLoop() {
        return !m_modelExplainer.hasNextIteration();
    }
    ...
    protected void loadValidatedSettingsFrom(final NodeSettingsRO settings) throws InvalidSettingsException {
        m_settings = new ModelExplainerSettings();
    ...
    protected void reset() {
        if (m_modelExplainer != null) {
            m_modelExplainer.reset();
        }
        m_modelExplainer = null;
    }
