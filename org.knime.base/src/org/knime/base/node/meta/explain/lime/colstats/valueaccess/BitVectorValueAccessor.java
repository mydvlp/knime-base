 ...
 */
public final class BitVectorValueAccessor implements NumericValueAccessor {

    private final int m_idx;

    private boolean m_value;

    private final Caster<BitVectorValue> m_caster;

    BitVectorValueAccessor(final int idx) {
        m_idx = idx;
        m_caster = new Caster<>(BitVectorValue.class, false);
    }
    ...
    public void accept(final DataCell cell) {
        final BitVectorValue value = m_caster.getAsT(cell);
